...
class Event_Upload_ViewController: UIViewController, UITextFieldDelegate, UITextViewDelegate {
...
extension Event_Upload_ViewController: UITableViewDataSource, UITableViewDelegate {

func tableView(_ tableView: UITableView, heightForRowAt indexPath: IndexPath) -> CGFloat {
    return tableView == tableViewFiles ? 38 : 550 // tableView.frame.size.height - 0
}
