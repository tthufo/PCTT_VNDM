...
class PC_HD_ViewController: UIViewController {
    ...
    override func viewDidLoad() {
       ...
       if Information.check == "0" {
        ...
        if result != nil {
            let layers = (result["data"] as! NSDictionary)["listDayHDUPs"]
...
extension PC_HD_ViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        icon.image = UIImage.init(named: "tab11")
